    ...
    <div style={{ maxWidth: 820, margin: "0 auto", padding: "48px 24px 96px" }}>
      ...
      <Art n="1" title="Définitions">
        <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
          ...
          <Li><strong>Partenaire Fondateur :</strong> tout partenaire ayant complété le programme d'intégration obligatoire (LOI + Accord de Partenariat Fondateur), condition préalable à toute publication.</Li>
        </ul>
      </Art>
      ...
      <Art n="6" title="Programme Partenaire Fondateur">
        <p>
          Le programme <strong>Partenaire Fondateur</strong> (Letter of Intent + Accord de Partenariat) fait partie
          du parcours d'intégration de <strong>tout</strong> nouveau partenaire, quel que soit son statut
          (particulier, professionnel, entreprise, exportateur) — sa complétion est une condition préalable
          à toute publication d'annonce sur la plateforme. Il donne accès aux avantages suivants :
        </p>
        <ul style={{ listStyle: "none", padding: 0, margin: "10px 0 0" }}>
