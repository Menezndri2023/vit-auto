// ── Devises et pays de référence ───────────────────────────────────────────
//
// Données de départ des collections ExchangeRate et CountryConfig. Servent à
// la migration de production (scripts/migrate-currency-config.mjs) ET à la
// pile locale de la garde (scripts/apiLocale.mjs) : sans devise active, la
// publication d'annonce refusait toute devise d'affichage (« Devise
// d'affichage invalide ») et l'affichage des prix convertis n'était jamais
// exercé localement (audit des parcours, 2026-09-15).
