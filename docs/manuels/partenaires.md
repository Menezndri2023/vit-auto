...
- **Réservations classiques** : confirmer/refuser sous 24h, préparer le véhicule, gérer la livraison GPS si applicable. Une demande de location ou d'activité est d'abord validée par VIT AUTO avant de vous être transmise.
- **Missions chauffeur** : transmises **directement**, sans validation préalable (depuis le 2026-09-14) — la demande apparaît dans vos commandes à l'instant où le client la confirme, à vous de l'accepter ou de la refuser (délai de réponse et rappels habituels). Règlement en espèces, auprès de vous, à la prestation.
